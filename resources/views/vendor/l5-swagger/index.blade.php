...
<head>
    ...
    *:after
    ...
    /* Custom styles for auth info box only */
    
    /* Fix scheme container (servers dropdown, authorize button, filter) at bottom */
    ...
    @if(config('l5-swagger.defaults.ui.display.dark_mode'))
        <style>
            ...
            /* Auth info for dark mode only */
            
            /* Fixed scheme container for dark mode */
